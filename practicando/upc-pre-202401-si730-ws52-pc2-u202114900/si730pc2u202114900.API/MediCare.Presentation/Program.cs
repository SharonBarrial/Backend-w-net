...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "An ASP.NET Core Web API for managing Appoinments. Created by Sharon Barrial, a software engineering student of UPC with a code student: u202114900.",
...
builder.Services.AddScoped<IAppoinmentCommandService, AppoinmentCommandService>();
